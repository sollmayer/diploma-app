...
export const ServerChannel = ({channel, server, role}: ServerChannelProps) => {
    ...
    return (
        ...
        className={cn("group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
            ...
            <p className={cn("line-clamp-1 font-semibold text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 dark:group-hover:max-w-[7.5rem] overflow-hidden transition",
